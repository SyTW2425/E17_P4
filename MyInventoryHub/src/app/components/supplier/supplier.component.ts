...
@Component({
  ...
  standalone: true,
  templateUrl: './supplier.component.html', // Actualizado el nombre del archivo HTML
  imports: [CommonModule, FormsModule],
  styleUrls: ['./supplier.component.css'], // Actualizado el nombre del archivo de estilos
})
